...
Given I am a SEAT logged in dealer
When I navigate to the add vehicle page
Then The CAP lookup is available
# Test Data:  bobseat@coxauto.co.uk/Password1234
...
Given I have successfully performed a cap lookup
When I click continue button(arrow)
Then I am directed to the main data screen

Scenario: Add main vechicle data
...
And the model range validation is no longer displayed
