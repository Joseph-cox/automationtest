...
@tag
Scenario: To verify if the user can view images using the button arrows When any of the arrow buttons are selected
...
And pushing the mouse on either of the sides
...
Then the available imported video should play
Or alternatively when the user selects the image with the play icon
...
Then by selecting the interior icon, the 360 interior view will start
