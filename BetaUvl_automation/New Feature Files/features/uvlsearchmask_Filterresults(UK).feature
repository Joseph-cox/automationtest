...
And The price of first vehicle returned is greater than the min price selected
...
And The nearest dealer vehicles will be returned first in the results
And right after viewing the whole nearest dealer stock
