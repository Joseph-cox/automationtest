...
Then the order for the items on the second level should be as follows:
                                                                   ...
                                                                   #Car configurator	My Volvo	Our story	Support &manuals
                                                                   #Inventory >	Create Volvo ID	Our heritage	Service & maintenance
                                                                    #Finance & offers >	Manage Volvo ID	Sustainability	Warranty & recall
                                                                    #Test drive	Volvo on Call app	Safety	Accident & repair
                                                                    #Car comparison	Stories & inspiration	Connectivity	Download maps
                                                                     #Pricelists	eNewsletter signup	Electrification	Contact us
                                                                     #Owner reviews	 	This is Volvo Cars
                                                                     #Accessories	 	News
...
Then if any of them is chosen from the list
Then the user is redirected to the above linked pages