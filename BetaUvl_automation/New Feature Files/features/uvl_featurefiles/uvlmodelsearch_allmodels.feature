...
Scenario: To verify user can search for all vehicles and no models are selected
...
Scenario: To verify user can search for all models and  no models are selected
When the user clicks "x cars found" button
Then notes down the stock count
Then you are directed to the results page
And the model filter states "Select"
And the "x cars found" count matches the homepage button