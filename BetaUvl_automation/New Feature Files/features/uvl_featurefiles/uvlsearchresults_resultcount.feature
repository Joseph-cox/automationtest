...
Then the user performs a search without selecting a model
...
Then notes down the 'X cars found' button count
And the user performs a search
And The 'X cars found' count on results matches the count noted down on the home
And the results count in the pagination matches the count noted down on the homepage
