...
As a Modix UVL user
I want to be able to select the preferred one soon after the UVL is accessed
and have the possibility to change the language whenever is desired
...
Scenario: To verify if the pop-up can be dismissed without selecting a language
