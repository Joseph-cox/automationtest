Feature: Add coming soon vehicle to inventory

_Scenario: Navigate to add vehicle screen
...
WhenI enter the following data:
...
AND The availability text is displayed ("Availability date (This vehicle will be automatically classified as used vehicle in 90 day(s)")
