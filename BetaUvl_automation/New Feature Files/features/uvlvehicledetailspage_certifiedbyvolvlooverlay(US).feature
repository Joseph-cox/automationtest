...
Feature: UVL Vehicle Details Page - Certified by Volvo & 'Read more' content page
...
Given: The user navigates to the UVL "Vehicle Details Page"
...
Then the user selects the close button Or clicks anywhere out of the pop-up
 And the overlay will be dismissed
