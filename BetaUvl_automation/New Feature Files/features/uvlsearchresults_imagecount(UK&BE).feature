...
Then after seeing each vehicle into the returned list
...
Then  checking the image indicator
...
Then  navigating to the Vehicle detail page
Then the image count should be consistent here too Or the BE Modix CMS for that vehicle could be check alternatively