...
Then User scrolls down to the pagination function
Then the pagination should be displayed

Scenario: To verify pagination functionality
When  User clicks on page number 3 in the pagination
...
Scenario: To verify pagination functionality does not exist when less than 1 page 
When Results Page loads with less vehicles than 1 page
Then User scrolls down to the pagination function
Then pagination should not be displayed

Scenario: To verify pagination on change of search criteria 
When Results Page loads
Then click on page number X in the pagination (where x is the last page number)
Then the page should refresh and should shows page X of the search results 
Then I change the search criteria in the mask and clicks search
