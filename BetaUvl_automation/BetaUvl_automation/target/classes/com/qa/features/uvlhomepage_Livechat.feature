...
When the page loads
Then verifying the bottom right of the page
And the Live chat icon should be present
...
When trying to close the chat window By selecting either the arrow or 'X' button
...
Then after accessing again the UVL
And the conversation will start from where it remained