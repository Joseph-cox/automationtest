...
#_Test Data: bobvw@coxauto.co.uk / Password1234
...
Then The following model range validation message is displayed in the header:"Vehicles without model range are not accepted"
...
When I Enter the following Data:
                                # Registration number (random generated function )
                                 #VIN(randomgenerated function )
                                  #First Registration date (Function = today -91days)
                                    #Vehicle type=Used vehicle Primary Colour Colour
                                    #- Interior 
                                   #interior fittings 
                                   #Fuel type 
                                   #Transmission 
...
When I navigate tothe 'Equipment check' screen
...
Then he selected value is added successfully


Scenario: Image screen
Given I have completed the equiipment screen
When I Click Continue
Then I am direced to the image screen
