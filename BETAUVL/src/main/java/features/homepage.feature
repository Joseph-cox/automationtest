...
Scenario: To verify homepage title displayed
Then Verify that the homepage title is displayed
Scenario: To verify homepage title search button displayed
Then Verify that the homepage title search button is displayed
